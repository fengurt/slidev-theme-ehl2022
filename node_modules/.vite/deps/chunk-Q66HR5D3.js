...
var nr2 = async () => {
  const { diagram: t } = await import("./c4Diagram-d4b415eb-DMIILMKI.js");
...
var ir = async () => {
  const { diagram: t } = await import("./flowDiagram-7d05970f-VAQVGZ2C.js");
...
var mr = async () => {
  const { diagram: t } = await import("./flowDiagram-v2-6bfe9e0e-MCUUIEFQ.js");
...
var gr2 = async () => {
  const { diagram: t } = await import("./erDiagram-215b0341-VNE4YOQF.js");
...
var $r = async () => {
  const { diagram: t } = await import("./gitGraphDiagram-603d2a33-E342ZW56.js");
...
var Dr = async () => {
  const { diagram: t } = await import("./ganttDiagram-6b6599ba-KFWKXKHT.js");
...
var kr = async () => {
  const { diagram: t } = await import("./pieDiagram-ffb7c1e5-MARC77AO.js");
...
var Rr2 = async () => {
  const { diagram: t } = await import("./requirementDiagram-51a5ec78-AEYFY45O.js");
...
var zr = async () => {
  const { diagram: t } = await import("./sequenceDiagram-3b765acc-WTHQ2HHD.js");
...
var Nr2 = async () => {
  const { diagram: t } = await import("./classDiagram-7b4b2ee6-QSVI4AJN.js");
...
var qr = async () => {
  const { diagram: t } = await import("./classDiagram-v2-556a8c31-MBDKOL5S.js");
...
var Qr = async () => {
  const { diagram: t } = await import("./stateDiagram-d14e810e-B72N5UZG.js");
...
var ra = async () => {
  const { diagram: t } = await import("./stateDiagram-v2-c3d22c51-WJ7J66YD.js");
...
var oa = async () => {
  const { diagram: t } = await import("./journeyDiagram-420adb66-KOLKPTKW.js");
...
var ga = async () => {
  const { diagram: t } = await import("./flowchart-elk-definition-55d9b0bb-W6BAKSDN.js");
...
var Da = async () => {
  const { diagram: t } = await import("./mindmap-definition-b90592f0-PNXYA6UG.js");
...
//# sourceMappingURL=chunk-Q66HR5D3.js.map
