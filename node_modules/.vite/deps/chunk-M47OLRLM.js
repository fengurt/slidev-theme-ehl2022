...
var nr2 = async () => {
  const { diagram: t } = await import("./c4Diagram-d4b415eb-VTX36ESR.js");
...
var ir = async () => {
  const { diagram: t } = await import("./flowDiagram-7d05970f-J5GZV4GA.js");
...
var mr = async () => {
  const { diagram: t } = await import("./flowDiagram-v2-6bfe9e0e-IFTMAGX4.js");
...
var gr2 = async () => {
  const { diagram: t } = await import("./erDiagram-215b0341-SYGBLOSX.js");
...
var $r = async () => {
  const { diagram: t } = await import("./gitGraphDiagram-603d2a33-XKMQQ6ZU.js");
...
var Dr = async () => {
  const { diagram: t } = await import("./ganttDiagram-6b6599ba-CS4PX7CF.js");
...
var kr = async () => {
  const { diagram: t } = await import("./pieDiagram-ffb7c1e5-EG5WNE6F.js");
...
var Rr2 = async () => {
  const { diagram: t } = await import("./requirementDiagram-51a5ec78-OGSRB7SD.js");
...
var zr = async () => {
  const { diagram: t } = await import("./sequenceDiagram-3b765acc-GVMIQFUT.js");
...
var Nr2 = async () => {
  const { diagram: t } = await import("./classDiagram-7b4b2ee6-3AVU2RWV.js");
...
var qr = async () => {
  const { diagram: t } = await import("./classDiagram-v2-556a8c31-OOV7PS4G.js");
...
var Qr = async () => {
  const { diagram: t } = await import("./stateDiagram-d14e810e-747TAKCC.js");
...
var ra = async () => {
  const { diagram: t } = await import("./stateDiagram-v2-c3d22c51-ZDKOQCZS.js");
...
var oa = async () => {
  const { diagram: t } = await import("./journeyDiagram-420adb66-VGPLIH56.js");
...
var ga = async () => {
  const { diagram: t } = await import("./flowchart-elk-definition-55d9b0bb-4KKSDPZ4.js");
...
var Da = async () => {
  const { diagram: t } = await import("./mindmap-definition-b90592f0-4FBRZIKP.js");
...
//# sourceMappingURL=chunk-M47OLRLM.js.map
