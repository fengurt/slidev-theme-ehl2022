...
var require_fast_deep_equal = _chunkVG7QAVECjs.__commonJS.call(void 0, {
...
function createWindiCSSPlugin({themeRoots, clientRoot}, {windicss: windiOptions}) {
  return _vitepluginwindicss2.default.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {
    configFiles: [
...
var import_fast_deep_equal = _chunkVG7QAVECjs.__toModule.call(void 0, require_fast_deep_equal());
...
function prepareSlideInfo(data) {
  return _chunkVG7QAVECjs.__spreadProps.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {}, data), {
...
function createSlidesLoader({data, entry, clientRoot, themeRoots, userRoot}, pluginOptions, VuePlugin, MarkdownPlugin) {
  ...
  return [
    {
      ...
      async handleHotUpdate(ctx) {
        ...
        const vueModules = (await Promise.all(Array.from(hmrPages).map(async (i) => {
          ...
          return await VuePlugin.handleHotUpdate(_chunkVG7QAVECjs.__spreadProps.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {}, ctx), {
  ...
  async function transformMarkdown(code, pageNo, data2) {
    ...
    const frontmatter = _chunkVG7QAVECjs.__spreadValues.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {}, ((_a = data2.headmatter) == null ? void 0 : _a.defaults) || {}), ((_b = data2.slides[pageNo]) == null ? void 0 : _b.frontmatter) || {});
...
${routes.join(",\n")}
  ...
  function generateConfigs() {
    const config = _chunkVG7QAVECjs.__spreadValues.call(void 0, {}, data.config);
...
function resolveShikiOptions(options) {
  ...
  return _chunkVG7QAVECjs.__spreadProps.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {}, options), {
    themes,
...
async function createMarkdownPlugin({data: {config}, roots, mode, entry}, {markdown: mdOptions}) {
  ...
  if (config.highlighter === "shiki") {
    const {getHighlighter} = await Promise.resolve().then(() => _chunkVG7QAVECjs.__toModule.call(void 0, require("shiki")));
  ...
  return _vitepluginmd2.default.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {
    wrapperClasses: "",
    headEnabled: false,
    frontmatter: false,
    markdownItOptions: {
...
async function ViteSlidevPlugin(options, pluginOptions) {
  ...
  const VuePlugin = _pluginvue2.default.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {
    include: [/\.vue$/, /\.md$/],
    exclude: [],
    template: {
      compilerOptions: {
  ...
  return [
    ...
    _viteplugincomponents2.default.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {
    ...
    _vitepluginicons2.default.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {}, iconsOptions)),
    config.remoteAssets === true || config.remoteAssets === mode ? _vitepluginremoteassets2.default.call(void 0, _chunkVG7QAVECjs.__spreadValues.call(void 0, {
      rules: [
