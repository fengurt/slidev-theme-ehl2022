import {
  createServer
} from "./chunk-BS2UNNZB.mjs";
import "./chunk-NYTXF6HX.mjs";
import {
  getThemeRoots,
  isRelative,
  resolveOptions,
  resolveThemeName
} from "./chunk-2CLDTRQT.mjs";
import {
  __toModule
} from "./chunk-DWQ2HAOG.mjs";
...
cli.command("build [entry]", "Build hostable SPA", (args) => commonOptions(args).option("watch", {
  ...
  const {build} = await Promise.resolve().then(() => __toModule(require("./build-XUQRPFWS.mjs")));
...
cli.command("export [entry]", "Export slides to PDF", (args) => commonOptions(args).option("output", {
  ...
  const {exportSlides} = await Promise.resolve().then(() => __toModule(require("./export-WRQ4ACCT.mjs")));
