...
var _chunkCWV5AMYBjs = require('./chunk-CWV5AMYB.js');
...
async function build(options, pluginOptions = {}, viteConfig = {}) {
  ...
  await _fsextra2.default.writeFile(indexPath, await _chunkCWV5AMYBjs.getIndexHtml.call(void 0, options), "utf-8");
  let config = void 0;
  try {
    await _vite.build.call(void 0, _vite.mergeConfig.call(void 0, viteConfig, {
      plugins: [
        await _chunkCWV5AMYBjs.ViteSlidevPlugin.call(void 0, options, pluginOptions),
        {
          name: "resolve-config",
