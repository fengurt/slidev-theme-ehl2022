...
async function exportSlides({
  ...
  if (!_chunkGELV3XCVjs.packageExists.call(void 0, "playwright-chromium"))
    throw new Error("The exporting for Slidev is powered by Playwright, please installed it via `npm i playwright-chromium`");
  const {chromium} = await Promise.resolve().then(() => _chunkVG7QAVECjs.__toModule.call(void 0, require("playwright-chromium")));
